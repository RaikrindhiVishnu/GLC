...
const path = 'c:\\\\Users\\\\DELL\\\\OneDrive\\\\Desktop\\\\GLC\\\\src\\\\app\\\\search\\\\filter\\\\FilterOverlay.tsx';
let content = fs.readFileSync(path, 'utf8');

const targetRegex = /<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#75777D" strokeWidth="2" className="absolute left-4">\s*<path d="M3 6l6-3 6 3 6-3v12l-6 3-6-3-6 3V6z"><\/path>\s*<\/svg>/g;

const replacementSVG = `<svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute left-4">
...
const result = content.replace(targetRegex, replacementSVG);
