      ...
      <div className="lg:hidden flex flex-col w-full px-6 gap-12">
        ...
        <div className="flex flex-col gap-8">
          ...
          >
            ...
            <div className="relative aspect-[4/3] rounded-[20px] overflow-hidden">
              <Image src="/assets/features/hydro3.2.jpg" alt="Water" fill className="object-cover" />
              <div className="absolute bottom-4 left-4 right-4 bg-black/20 backdrop-blur-md rounded-full flex items-center p-2">
          ...
          >
            ...
            <div className="relative aspect-[4/3] rounded-[20px] overflow-hidden">
              <Image src="/assets/features/gis3.3.jpg" alt="GIS" fill className="object-cover" />
              <div className="absolute top-4 left-4 bg-white rounded-full flex items-center p-2 shadow-md pr-4">
          ...
          >
            ...
            <div className="relative aspect-[4/3] rounded-[20px] overflow-hidden">
              ...
              <div className="absolute inset-4 flex flex-col gap-4">
                <div className="flex-1 bg-white/90 backdrop-blur-md rounded-[15px] p-4 flex flex-col justify-center">
                  <span className="text-[12px] text-[#5C5C5C]">Last Payout:</span>
                  <span className="text-[28px] font-bold text-[#0F2F4C]">
                    <DynamicCounter value={380000} prefix="₹" />
                  </span>
                  <span className="text-[12px] text-[#2780C4]">Cleared (Oct 2025)</span>
                </div>
                <div className="flex-1 bg-white/90 backdrop-blur-md rounded-[15px] p-4 flex flex-col justify-center">
                  <span className="text-[12px] text-[#5C5C5C]">Next Harvest:</span>
                  <span className="text-[24px] font-bold text-[#0F2F4C]">Nov 2026</span>
                  <span className="text-[11px] text-[#5C5C5C]">Red Sandalwood</span>
                </div>
              </div>
            </div>
          </motion.div>
