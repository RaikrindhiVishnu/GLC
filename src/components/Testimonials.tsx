...
function TestimonialCard({ t }: { t: any }) {
  return (
    <div className="flex flex-col shrink-0 w-[290px] md:w-[360px] lg:w-[388px] h-[210px] md:h-[225px] lg:h-[235px] bg-white rounded-[24px] md:rounded-[32px] p-5 md:p-7 lg:p-[32px] gap-[16px] shadow-[0px_1px_2px_rgba(0,0,0,0.05)]">
      ...
      {/* Quote */}
      <p className="flex-1 text-[14px] md:text-[15px] lg:text-[16px] leading-[1.5] italic text-[#45474C] font-jakarta m-0">
        "{t.text}"
      </p>
      ...
      <div className="flex items-center gap-[16px] pt-[8px]">
        ...
        <div className="flex flex-col justify-center gap-0">
          ...
          <h4 className="text-[14px] md:text-[16px] font-bold text-[#131600] font-jakarta leading-[24px] m-0">
            {t.name}
          </h4>

          <p className="text-[11px] md:text-[12px] text-[#45474C] font-jakarta leading-[16px] m-0">
            {t.role}
          </p>
