          ...
          <div
            ...
            <div style={{
              ...
              <div style={{
                width: "100%",
                height: "256px",
                backgroundImage: "url('/assets/search/verified/GLC SOS 01 property view.svg')", // Updated to use the correct explicitly provided image
              ...
              <div style={{ padding: "32px", display: "flex", flexDirection: "column", gap: "24px" }}>
                <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                    <div style={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
                      <img src="/assets/search/verified/Container (30).svg" alt="Verified" width={22} height={21} />
                    </div>
                ...
                <div style={{ background: "#EEF6FF", border: "1px solid rgba(39, 128, 196, 0.1)", borderRadius: "16px", padding: "24px", display: "flex", gap: "12px", alignItems: "flex-start" }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: "2px" }}>
                    <img src="/assets/search/verified/Container (29).svg" alt="Unlocked" width={16} height={21} />
                  </div>
              ...
              <div style={{ width: "496px", display: "flex", justifyContent: "space-between", alignItems: "flex-end", flexShrink: 0 }}>
                <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                    ...
                    <h2 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: "30px", lineHeight: "36px", letterSpacing: "-0.75px", color: "#0F2F4C", margin: 0, width: activeCategory ? "auto" : "221px", whiteSpace: "pre-wrap" }}>
              ...
              <div className="hide-scroll" style={{ background: "#F3F4F5", borderRadius: "24px", width: "496px", padding: "8px", display: "flex", flexDirection: "column", gap: "8px", boxSizing: "border-box", flexShrink: 0 }}>
                ...
                {(() => {
                  const items = [
                    ...
                    { label: "Land & Boundaries", btnText: "View Documents", icon: <img src="/assets/search/verified/Background (23).svg" alt="Land & Boundaries" width={38} height={38} /> },
                    { label: "Valuation", btnText: "View Documents", icon: <img src="/assets/search/verified/Background (24).svg" alt="Valuation" width={38} height={38} /> },
                    { label: "Permanent GIS\nBoundary Map", btnText: "View Documents", icon: <img src="/assets/search/verified/Background (25).svg" alt="Permanent GIS Boundary Map" width={38} height={38} /> }
                  ];
                  ...
                  if (!activeCategory) {
                    ...
                    return items.map((item, idx) => (
                      <div key={idx} style={{ width: "480px", height: "96px", background: "#FFFFFF", borderRadius: "16px", display: "flex", alignItems: "center", padding: "0 24px", boxSizing: "border-box", position: "relative" }}>
                        ...
                        <span style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: "16px", color: "#0F2F4C", marginLeft: "16px", whiteSpace: "pre-wrap" }}>
                          {item.label}
                        </span>
                  ...
                  const categoryKeyMap: Record<string, string> = {
                    ...
                    "Valuation": "valuation",
                    "Permanent GIS\nBoundary Map": "permanent_gis_docs"
                  };
