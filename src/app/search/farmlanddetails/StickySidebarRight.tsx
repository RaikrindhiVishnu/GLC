  ...
  return (
    <aside style={{ width: "100%", display: "flex", flexDirection: "column", gap: "24px" }}>
      ...
      <motion.div
        ...
        style={{ width: "100%", background: "#FFFFFF", border: "1px solid rgba(237,238,239,0.5)", boxShadow: "0px 1px 2px rgba(0,0,0,0.05)", borderRadius: "32px", padding: "28px", boxSizing: "border-box", display: "flex", flexDirection: "column", gap: "28px" }}
        className="lg:rounded-[48px] lg:p-8"
      >
        <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
          <h2 style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: "24px", lineHeight: "32px", letterSpacing: "-0.6px", color: "#262C00", margin: 0 }}>{title}</h2>
          <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
            <svg width="10" height="12" viewBox="0 0 24 24" fill="none" stroke="#45474C" strokeWidth="2.5">
              <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z" /><circle cx="12" cy="10" r="3" />
            </svg>
            <span style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 400, fontSize: "14px", color: "#45474C" }}>{locationSubtitle}</span>
          </div>
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: "4px" }}>
          <span style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: "10px", letterSpacing: "1px", textTransform: "uppercase", color: "#45474C" }}>VALUATION</span>
          <span style={{ fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: "48px", lineHeight: "48px", letterSpacing: "-2.4px", color: "#0F2F4C" }}>{price}</span>
        </div>
      ...
      <motion.div
        ...
        style={{ width: "100%", background: "#091426", borderRadius: "32px", padding: "28px", boxSizing: "border-box", display: "flex", flexDirection: "column", alignItems: "center", isolation: "isolate" }}
        className="lg:rounded-[48px] lg:p-8"
      >
      ...
      <motion.button
        ...
        style={{ width: "100%", height: "64px", background: "radial-gradient(50% 50% at 50% 50%, #2780C4 0%, #164573 100%)", borderRadius: "48px", border: "none", color: "#FFFFFF", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: "16px", cursor: "pointer", boxShadow: "0px 20px 25px -5px rgba(0,0,0,0.1), 0px 8px 10px -6px rgba(0,0,0,0.1)" }}
      >
        View Verified Docs
      </motion.button>
