  ...
  return (
    <section className="relative w-full h-[80vh] md:h-screen min-h-125 md:min-h-160 flex flex-col items-center justify-center overflow-hidden shrink-0 select-none">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-linear-to-t from-black/40 via-black/20 to-black/40 z-1" />
      </div>

      {/* Responsive Navigation Suite */}
      <div className="absolute top-0 left-0 right-0 z-20 flex items-center justify-between px-4 md:px-12 lg:px-15 pt-7.5 md:pt-6">
        {/* Brand Logo */}
        <div
        ...
        <div className="hidden md:flex flex-row items-center p-2 gap-2 bg-white/10 backdrop-blur-xl rounded-full border border-white/10 shadow-[0_8px_6px_rgba(0,0,0,0.05)]">
          ...
          >
            <Image src="/assets/home/HeroScreen/search.svg" alt="Search" width={20} height={20} className="w-5 h-5 lg:w-5.5 lg:h-5.5" />
          </button>
          ...
          >
            <Image src="/assets/home/HeroScreen/Vector.svg" alt="Pricing Vector" width={20} height={18} className="w-5 h-4.5" />
          </button>
          ...
          >
            <Image src="/assets/home/HeroScreen/user 1.png" alt="Profile shortcut" width={20} height={20} className="w-5 h-5" />
          </button>
        </div>
        ...
        <div className="flex items-center gap-2 md:gap-3 shrink-0">
          <button
            ...
            className="flex items-center justify-center w-9 h-9 md:w-13 md:h-13 bg-white/10 backdrop-blur-xl rounded-full border border-white/10 transition-transform hover:scale-105 active:scale-95 shadow-sm"
            title="Unlocked Documents"
          >
            <Image src="/assets/home/HeroScreen/unlock 1.svg" alt="Unlock badge" width={24} height={24} className="w-4 h-4 md:w-6.5 md:h-6.5" />
          </button>
      ...
      <div className="relative z-10 flex flex-col items-center px-4 md:px-6 w-full max-w-300 mx-auto gap-8 text-center pointer-events-auto">
        <motion.h1
          initial={{ opacity: 0, filter: "blur(8px)", y: 15 }}
          animate={{ opacity: 1, filter: "blur(0px)", y: 0 }}
          transition={{ duration: 0.8, delay: 0.2 }}
          className="text-[38px] sm:text-[56px] md:text-[80px] lg:text-[100px] font-extrabold text-white leading-tight tracking-tight md:tracking-[-1.8px] drop-shadow-md"
        >
          Support Centre
        </motion.h1>
        <motion.p
          ...
          className="text-xs sm:text-base md:text-xl lg:text-[24px] font-medium text-white/95 leading-8 w-275 max-w-[95vw] mx-auto drop-shadow-sm px-2"
        >
