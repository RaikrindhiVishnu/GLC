    ...
    <main style={{ width: "100%", minHeight: "100vh", backgroundColor: "#F8F9FA", display: "flex", flexDirection: "column", overflowX: "hidden" }}>
      ...
      <div className="block lg:hidden">
        ...
        <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, zIndex: 50, display: "flex", gap: "10px", padding: "12px 16px", background: "rgba(255,255,255,0.97)", borderTop: "1px solid #EDEEEF", backdropFilter: "blur(8px)", boxSizing: "border-box" }}>
          <button onClick={() => alert("Initiating institutional escrow deposit layer for GLC SOS 01...")} style={{ flex: 1, height: "48px", background: "radial-gradient(50% 50% at 50% 50%, #2780C4 0%, #164573 100%)", borderRadius: "9999px", border: "none", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: "12px", color: "#FFFFFF", cursor: "pointer" }}>
            SELECT SOS 01
          </button>
          <button onClick={() => alert("Initiating institutional escrow deposit layer for GLC SOS 02...")} style={{ flex: 1, height: "48px", background: "radial-gradient(50% 50% at 50% 50%, #2780C4 0%, #164573 100%)", borderRadius: "9999px", border: "none", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: "12px", color: "#FFFFFF", cursor: "pointer" }}>
            SELECT SOS 02
          </button>
        </div>
      ...
      <div className="hidden lg:block">
        ...
        <section style={{ boxSizing: "border-box", display: "flex", flexDirection: "column", alignItems: "flex-start", padding: "64px 32px", gap: "38px", width: "100%", maxWidth: "1280px", margin: "0 auto" }}>
          ...
          <div style={{ boxSizing: "border-box", display: "flex", flexDirection: "row", alignItems: "center", justifyContent: "space-between", width: "1216px", padding: "24px 32px", background: "rgba(255,255,255,0.95)", borderTop: "1px solid rgba(197,198,205,0.2)", borderRadius: "24px", boxShadow: "0px -10px 40px rgba(0,0,0,0.03)", gap: "48px", marginTop: "40px" }}>
            <button onClick={() => alert("Initiating institutional escrow deposit layer for GLC SOS 01...")} style={{ flex: 1, height: "52px", background: "radial-gradient(50% 50% at 50% 50%, #2780C4 0%, #164573 100%)", borderRadius: "9999px", border: "none", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: "14px", letterSpacing: "0.35px", color: "#FFFFFF", cursor: "pointer" }} onMouseEnter={(e) => (e.currentTarget.style.opacity = "0.9")} onMouseLeave={(e) => (e.currentTarget.style.opacity = "1")}>SELECT GLC SOS 01</button>
            <button onClick={() => alert("Initiating institutional escrow deposit layer for GLC SOS 02...")} style={{ flex: 1, height: "52px", background: "radial-gradient(50% 50% at 50% 50%, #2780C4 0%, #164573 100%)", borderRadius: "9999px", border: "none", fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 700, fontSize: "14px", letterSpacing: "0.35px", color: "#FFFFFF", cursor: "pointer" }} onMouseEnter={(e) => (e.currentTarget.style.opacity = "0.9")} onMouseLeave={(e) => (e.currentTarget.style.opacity = "1")}>SELECT GLC SOS 02</button>
          </div>
