...
export default function CompareAssets() {
  ...
  useEffect(() => {
    function update() {
      ...
      if (shellRef.current) {
        shellRef.current.style.height = `${835 * currentScale}px`;
      }
    }
    update();
              ...
              >
                ...
                <div style={{ display: "flex", gap: "24px" }}>
                  {comp.plots.map((plot, i) => (
                    ...
                    >
                      <div style={{ position: "relative", height: "176px", borderRadius: "16px", overflow: "hidden", flexShrink: 0 }}>
                        ...
                        >
                          <div style={{ width: "8px", height: "8px", background: "#006D37", borderRadius: "50%", flexShrink: 0 }} />
