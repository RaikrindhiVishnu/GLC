...
export default function DocumentUnlocks() {
  ...
  useEffect(() => {
    function update() {
      ...
      if (shellRef.current) {
        shellRef.current.style.height = `${688 * currentScale}px`;
      }
    }
    update();
          ...
          >
            ...
            >
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
                  <div style={{ width: "46px", height: "46px", background: "rgba(25, 79, 129, 0.2)", borderRadius: "50%", display: "flex", justifyContent: "center", alignItems: "center", flexShrink: 0 }}>
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "16px" }}>
                <svg width="16" height="21" viewBox="0 0 16 21" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ flexShrink: 0 }}>
              ...
              <button
                onClick={() => router.push("/unlockeddocuments")}
                style={{
                  width: "214px",
                  height: "60px",
