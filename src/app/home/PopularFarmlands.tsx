...
export default function PopularFarmlands() {
  ...
  useEffect(() => {
    function update() {
      ...
      if (shellRef.current) {
        shellRef.current.style.height = `${348.43 * currentScale}px`;
      }
    }
    update();
                ...
                >
                  <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "5px" }}>
                      ...
                      <div style={{ width: "8px", height: "10px", background: "#43474E", clipPath: "polygon(50% 0%, 100% 35%, 100% 70%, 50% 100%, 0% 70%, 0% 35%)", flexShrink: 0 }} />
