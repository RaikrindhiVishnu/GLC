...
export default function MaintenanceServicesHero() {
  ...
  return (
    ...
    >
      {/* Container holding primary dedicated services backdrop picture */}
      <div
        style={{
          display: "flex",
          flexDirection: "column",
      ...
      >
        ...
        <div style={{ position: "absolute", inset: 0, zIndex: 0 }}>
          <Image
            src="/assets/maintenance/serviceshero.svg"
            alt="Maintenance Services Dedicated Cover Preview"
            fill
            priority
      ...
      >
        ...
        {/* Two-line exact subtitle split string dump overlay block */}
        <div
          style={{
            display: "flex",
            flexDirection: "column",
      ...
      {/* Floating Bottom AI action floating shell matching the maintenance token string */}
      <div
        style={{
          boxSizing: "border-box",
          display: "flex",
      ...
      >
        ...
        <div style={{ width: "26px", height: "26px", borderRadius: "13px", background: "#FFFFFF", display: "flex", alignItems: "center", justifyContent: "center" }}>
          <span style={{ fontSize: "12px", color: "#0F2F4C", fontWeight: "bold" }}>AI</span>
        </div>
      </div>
    </section>
  );
