...
export default function MaintenanceHero({
  title = "Maintenance of Farmland",
  subtitle = "Keep your farmland productive with professional maintenance, agronomy support, irrigation management, and continuous field monitoring.",
  bgImage = "/assets/maintenance/Rectangle 4166 (26).svg"
  ...
  return (
    <>
      ...
      <div className="block lg:hidden relative w-full h-[80vh] min-h-125 overflow-hidden" style={{ background: "#091426" }}>
        <Image src={bgImage} alt="Maintenance of Farmland Hero" fill priority style={{ objectFit: "cover", objectPosition: "center", zIndex: 0 }} />
        ...
        <div ref={scalerRef} style={{ position: "absolute", top: 0, left: "50%", marginLeft: "-720px", width: "1440px", height: "960px", transformOrigin: "top center" }}>
          <section style={{ position: "relative", width: "1440px", height: "960px", background: "#091426", overflow: "hidden", display: "flex", justifyContent: "center" }}>
            ...
            <div style={{ position: "absolute", top: 0, left: "50%", transform: "translateX(-50%)", width: "1440px", height: "960px", zIndex: 20, pointerEvents: "none" }}>
              ...
              <div style={{ boxSizing: "border-box", display: "flex", flexDirection: "row", alignItems: "center", padding: "10px", gap: "10px", position: "absolute", width: "242px", height: "68px", left: "calc(50% - 121px)", top: "22px", background: "rgba(255,255,255,0.1)", boxShadow: "0px 8px 6px rgba(0,0,0,0.05), inset 3px 4px 2px -3px rgba(255,255,255,0.55), inset 0px -1px 1px rgba(255,255,255,0.25)", backdropFilter: "blur(50px)", borderRadius: "100px", pointerEvents: "auto", justifyContent: "space-between" }}>
                {[
              ...
              <button onClick={() => router.push("/home/unlockeddocuments")} style={{ position: "absolute", width: "52px", height: "51.39px", left: "1260px", top: "30px", background: "rgba(255,255,255,0.1)", backdropFilter: "blur(62.67px)", borderRadius: "125.333px", border: "none", boxShadow: "0px 10px 7.5px rgba(0,0,0,0.05), inset 0px 1.25px 1.25px rgba(255,255,255,0.25), inset 0px -1.25px 1.25px rgba(255,255,255,0.25), inset 3.76px 5px 2.5px -1px rgba(255,255,255,0.55)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", pointerEvents: "auto" }}>
                <Image src="/assets/home/HeroScreen/unlock 1.svg" alt="Unlock" width={26} height={26} />
              </button>
              <button onClick={() => router.push("/home/supportcenter")} style={{ position: "absolute", width: "52px", height: "51.39px", left: "1327px", top: "30px", background: "rgba(255,255,255,0.1)", backdropFilter: "blur(62.67px)", borderRadius: "125.333px", border: "none", boxShadow: "0px 10px 7.5px rgba(0,0,0,0.05), inset 0px 1.25px 1.25px rgba(255,255,255,0.25), inset 0px -1.25px 1.25px rgba(255,255,255,0.25), inset 3.76px 5px 2.5px -1px rgba(255,255,255,0.55)", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", pointerEvents: "auto" }}>
                <Image src="/assets/home/HeroScreen/notification-v2.svg" alt="Notifications" width={26} height={26} />
                
              </button>


              <div style={{ position: "absolute", width: "1100px", left: "calc(50% - 550px)", top: "310px", display: "flex", flexDirection: "column", alignItems: "center", gap: "37px", pointerEvents: "auto" }}>
                <motion.h1
                  initial={{ opacity: 0, filter: "blur(8px)", y: 20 }}
                  animate={{ opacity: 1, filter: "blur(0px)", y: 0 }}
                  transition={{ duration: 0.8, delay: 0.2 }}
                  style={{ margin: 0, fontFamily: "'Plus Jakarta Sans', sans-serif", fontWeight: 800, fontSize: "100px", lineHeight: "72px", textAlign: "center", letterSpacing: "-1.8px", color: "#FFFFFF", whiteSpace: "nowrap" }}
                >
                  {title}
                </motion.h1>
                <motion.p
