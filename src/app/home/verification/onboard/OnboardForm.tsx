  ...
  return (
    <section className="w-full max-w-[1248px] mx-auto px-4 lg:px-8 pt-16 pb-32 box-border flex flex-col items-start bg-[#F8F9FA]">
      ...
      <div className="w-full flex flex-col lg:flex-row gap-8 mb-12">
        ...
        <div className="flex-[1.1] flex flex-col gap-6">
          ...
          <div className="w-full h-[513px] bg-[#F1F5F9] rounded-[48px] relative overflow-hidden flex flex-col items-center justify-center p-6 shadow-[40px_0px_40px_rgba(9,20,38,0.04)] border border-[#E2E8F0]">
            <Image src="/assets/verification-of-farmland/hero.svg" alt="Map Placeholder" fill style={{ objectFit: "cover", opacity: 0.4, mixBlendMode: "saturation" }} />
            <div className="absolute inset-0 bg-gradient-to-b from-white/0 via-white/20 to-white/60 z-0" />
            <div className="relative z-10 flex flex-col items-center gap-4 mt-auto mb-20">
              <button className="bg-[#0F2F4C] text-white px-8 py-4 rounded-full font-jakarta font-bold text-[16px] leading-[24px] tracking-[0.4px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] flex items-center gap-3 hover:scale-105 transition-transform">
        ...
        <div className="flex-[1.1] flex flex-col gap-6">
          {/* Seller Information */}
          <div className="w-full h-[458px] bg-white rounded-[48px] p-10 shadow-[40px_0px_40px_rgba(9,20,38,0.04)] flex flex-col gap-8 relative">
            ...
            <div className="flex flex-col gap-2">
              ...
              <input type="text" value="Executive Name" readOnly className="bg-[#F3F4F5] rounded-[16px] px-6 py-[18px] font-jakarta font-normal text-[16px] leading-[20px] text-[#6B7280] outline-none h-[55px]" />
            </div>
            ...
            <div className="flex flex-row gap-4">
              <div className="flex flex-col gap-2 w-[160px]">
                ...
                <input type="text" value="+91" readOnly className="bg-[#F3F4F5] rounded-[16px] px-6 py-[18px] font-jakarta font-bold text-[16px] leading-[24px] text-[#191C1D] outline-none h-[56px]" />
              </div>
              <div className="flex flex-col gap-2 flex-1">
                ...
                <input type="text" placeholder="000 000 0000" readOnly className="bg-[#F3F4F5] rounded-[16px] px-6 py-[18px] font-jakarta font-normal text-[16px] leading-[20px] text-[#6B7280] outline-none h-[55px]" />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <input type="text" placeholder="Enter Amount" readOnly className="bg-[#F3F4F5] rounded-[16px] px-6 py-[18px] font-jakarta font-normal text-[16px] leading-[20px] text-[#6B7280] outline-none h-[55px]" />
            </div>
          </div>
      ...
      <div className="w-full flex justify-center px-4">
        <button
          onClick={() => router.push("/home/verification/request-success")}
          className="bg-[#0F2F4C] text-white font-jakarta font-bold text-[16px] px-12 py-4 rounded-full shadow-lg hover:scale-105 transition-transform"
        >
          Proceed to Payment
        </button>
      </div>
