...
export default function LoginPage() {
  ...
  return (
    <div className="w-full max-w-[480px]">
      ...
      {/* Title */}
      <p className="text-[30px] lg:text-[38px] text-[#353535] font-normal font-jakarta leading-tight flex flex-wrap gap-x-2">
      ...
      <h1 className="text-[30px] lg:text-[38px] font-bold text-[#2780C4] font-jakarta leading-tight mb-2 flex flex-wrap gap-x-2">
        {"Green Land Capital".split(" ").map((word, i) => (
          <motion.span
            key={i}
            initial={{ opacity: 0, filter: "blur(8px)", y: 10 }}
            animate={{ opacity: 1, filter: "blur(0px)", y: 0 }}
      ...
      <motion.p
        ...
        className="text-[14px] lg:text-[16px] text-[#B8B8B8] font-jakarta mb-6 lg:mb-8 leading-relaxed"
      >
      ...
      <motion.div
        ...
        className="mb-4 lg:mb-5 bg-white border border-[#D3DEEA] rounded-[33px] h-[58px] lg:h-[66px] flex items-center px-6 gap-3 focus-within:border-[#2780C4] focus-within:ring-1 focus-within:ring-[#2780C4]/20 transition-all cursor-text"
      >
      ...
      <motion.div
        ...
        className="mb-5 lg:mb-6 bg-white border border-[#D3DEEA] rounded-[33px] h-[58px] lg:h-[66px] flex items-center px-6 gap-3 focus-within:border-[#2780C4] focus-within:ring-1 focus-within:ring-[#2780C4]/20 transition-all cursor-text"
      >
        <svg className="w-5 h-5 text-[#2780C4] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <motion.button
        ...
        className="w-full h-[52px] lg:h-[58px] rounded-full text-[16px] font-bold text-[#2780C4] font-jakarta bg-[#F7F8F8] border-2 border-[#2780C4] [-webkit-tap-highlight-color:transparent] hover:bg-white transition-all cursor-pointer"
      >
        Login
      </motion.button>
