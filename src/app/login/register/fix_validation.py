...
file_path = "c:\\Users\\DELL\\OneDrive\\Desktop\\GLC\\src\\app\\login\\register\\page.tsx"
...
old_validation = """  const handleCreateAccount = async () => {
    if (!firstName.trim()) {
...
new_validation = """  const handleCreateAccount = async () => {
...
# Note: First Name container is the first occurrence of this exact class string
content = content.replace(
...
print("Validation script applied successfully.")
