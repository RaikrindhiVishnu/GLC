    ...
    <div className="flex flex-col w-full max-w-[448px]">
      ...
      <div className="flex flex-col text-left items-start w-full">
        ...
        <motion.h1
          ...
          className="text-[32px] lg:text-[40px] font-normal text-[#353535] font-jakarta leading-tight mb-1 lg:mb-2"
        >
          Mail Verification
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-[13px] lg:text-[15px] text-[#B8B8B8] font-jakarta leading-[1.5] max-w-[340px]"
        >
      ...
      <div className="flex flex-col items-center text-center w-full">
        ...
        <motion.h2
          ...
          className="text-[20px] lg:text-[24px] font-bold text-[#0F2F4C] font-jakarta mb-1 lg:mb-2 tracking-[-0.5px]"
        >
          Check Your Email
        </motion.h2>
        ...
        <motion.p
          ...
          className="text-[13px] lg:text-[15px] text-[#2A3008] font-jakarta mb-3 lg:mb-4 max-w-[340px] leading-[1.5]"
        >
          Password reset link sent your mail. Check your inbox to reset your password.
        </motion.p>
        ...
        <motion.div
          ...
          className="text-[14px] lg:text-[15px] text-[#404750] font-jakarta font-medium"
        >
          Didn't receive the email?{" "}
          <button className="text-[#2780C4] hover:underline font-semibold bg-transparent border-none cursor-pointer p-0 m-0 [-webkit-tap-highlight-color:transparent]">
