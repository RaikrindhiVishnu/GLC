    ...
    >
      ...
      <div className="block lg:hidden w-full" style={{ background: "#F0F1F2", zIndex: 10, position: "relative", paddingTop: "80px" }}>
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px", maxHeight: "192px", overflowY: "auto", paddingBottom: "8px" }}>
            {boughtFarmlands.length > 0 ? boughtFarmlands.map((item, idx) => {
              const colors = ["#059669", "#D97706", "#2563EB", "#7C3AED"];
              const color = colors[idx % colors.length];
              return (
                <div key={idx} onClick={() => router.push(`/profile/active-investment/${item.farmland_is}`)} style={{ cursor: "pointer", width: "100%", background: "linear-gradient(107.62deg, rgba(255, 255, 255, 0.7) 0%, rgba(255, 255, 255, 0.3) 100%)", border: "1px solid rgba(255, 255, 255, 0.8)", boxShadow: "0px 8px 32px rgba(0, 0, 0, 0.05)", backdropFilter: "blur(10px)", WebkitBackdropFilter: "blur(10px)", borderRadius: "24px", padding: "16px", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
        ...
        >
          ...
          {(profileDetails?.user_listed_farmlands || []).map((item: any, idx: number) => (
            <div key={idx} style={{ width: "100%", background: "linear-gradient(180deg, rgba(255, 255, 255, 0.7) 0%, rgba(255, 255, 255, 0.3) 100%)", border: "1px solid rgba(255, 255, 255, 0.8)", boxShadow: "0px 8px 32px rgba(0, 0, 0, 0.05)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", borderRadius: "24px", padding: "16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "16px", minWidth: 0, flex: 1 }}>
                <div style={{ width: "54px", height: "56px", background: "rgba(255, 255, 255, 0.6)", border: "1px solid #FFFFFF", boxShadow: "inset 0px 2px 4px 1px #FFFFFF", backdropFilter: "blur(2px)", WebkitBackdropFilter: "blur(2px)", borderRadius: "16px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={["#059669", "#D97706", "#2563EB", "#7C3AED"][idx % 4]} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z" /><path d="M2 22l10-10" /></svg>
                </div>
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px", maxHeight: "192px", overflowY: "auto", paddingBottom: "8px" }}>
            {(profileDetails?.user_purchased_lands_tracking || []).map((item: any, idx: number) => (
              <div key={idx} style={{ width: "100%", background: "linear-gradient(180deg, rgba(255, 255, 255, 0.7) 0%, rgba(255, 255, 255, 0.3) 100%)", border: "1px solid rgba(255, 255, 255, 0.8)", boxShadow: "0px 8px 32px rgba(0, 0, 0, 0.05)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", borderRadius: "24px", padding: "16px", display: "flex", alignItems: "center", justifyContent: "space-between", flexShrink: 0 }}>
                <div style={{ display: "flex", alignItems: "center", gap: "16px", minWidth: 0, flex: 1 }}>
                  <div style={{ width: "54px", height: "56px", background: "rgba(255, 255, 255, 0.6)", border: "1px solid #FFFFFF", boxShadow: "inset 0px 2px 4px 1px #FFFFFF", backdropFilter: "blur(2px)", WebkitBackdropFilter: "blur(2px)", borderRadius: "16px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={["#059669", "#D97706", "#2563EB", "#7C3AED"][idx % 4]} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z" /><path d="M2 22l10-10" /></svg>
                  </div>
      ...
      >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "12px", width: "100%" }}>
            ...
            <div style={{ background: "#FFFFFF", borderRadius: "32px", boxShadow: "0px 1px 2px rgba(0,0,0,0.05)", width: "381px", display: "flex", flexDirection: "column" }}>
              ...
              <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center", padding: "20px 24px", borderTop: "1px solid #FAFAFA", cursor: "pointer" }} onClick={() => router.push("/profile/savedfarmlands")}>
                <div style={{ display: "flex", alignItems: "center", gap: "16px", minWidth: 0, flex: 1 }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#A1A1AA" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6.5 1C3.4625 1 1 3.4625 1 6.5C1 12 7.5 17 11 18.163C14.5 17 21 12 21 6.5C21 3.4625 18.5375 1 15.5 1C13.64 1 11.995 1.9235 11 3.337C10.4928 2.61469 9.81897 2.0252 9.03568 1.61841C8.25238 1.21162 7.38263 0.999502 6.5 1Z"></path></svg>
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px", width: "100%" }}>
            ...
            <div data-lenis-prevent="true" className="hover-scrollbar" style={{ display: "flex", flexDirection: "column", gap: "16px", width: "100%", maxHeight: "212px", overflowY: "auto", paddingBottom: "8px", paddingRight: "4px" }}>
              {boughtFarmlands.length > 0 ? boughtFarmlands.map((item, idx) => {
                const colors = ["#059669", "#D97706", "#2563EB", "#7C3AED"];
                const color = colors[idx % colors.length];
                return (
                  <div key={idx} onClick={() => router.push(`/profile/active-investment/${item.farmland_is}`)} style={{ cursor: "pointer", width: "100%", background: "linear-gradient(180deg, rgba(255, 255, 255, 0.7) 0%, rgba(255, 255, 255, 0.3) 100%)", border: "1px solid rgba(255, 255, 255, 0.8)", boxShadow: "0px 8px 32px rgba(0, 0, 0, 0.05)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", borderRadius: "40px", padding: "20px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "16px", minWidth: 0, flex: 1 }}>
                      <div style={{ width: "54px", height: "56px", background: "rgba(255, 255, 255, 0.6)", border: "1px solid #FFFFFF", boxShadow: "inset 0px 2px 4px 1px #FFFFFF", backdropFilter: "blur(2px)", WebkitBackdropFilter: "blur(2px)", borderRadius: "16px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z" /><path d="M2 22l10-10" /></svg>
                      </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px", width: "100%" }}>
            ...
            <div data-lenis-prevent="true" className="hover-scrollbar" style={{ display: "flex", flexDirection: "column", gap: "16px", width: "100%", maxHeight: "98px", overflowY: "auto", paddingBottom: "8px", paddingRight: "4px" }}>
              {(profileDetails?.upcoming_site_visits || []).map((item: any, idx: number) => (
                <div key={idx} onClick={() => setIsSiteVisitQueueModalOpen(true)} style={{ cursor: "pointer", width: "100%", background: "linear-gradient(180deg, rgba(255, 255, 255, 0.7) 0%, rgba(255, 255, 255, 0.3) 100%)", border: "1px solid rgba(255, 255, 255, 0.8)", boxShadow: "0px 8px 32px rgba(0, 0, 0, 0.05)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", borderRadius: "40px", padding: "20px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "16px", minWidth: 0, flex: 1 }}>
                  <div style={{ width: "54px", height: "56px", background: "rgba(255, 255, 255, 0.6)", border: "1px solid #FFFFFF", boxShadow: "inset 0px 2px 4px 1px #FFFFFF", backdropFilter: "blur(2px)", WebkitBackdropFilter: "blur(2px)", borderRadius: "16px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={["#059669", "#D97706", "#2563EB", "#7C3AED"][idx % 4]} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z" /><path d="M2 22l10-10" /></svg>
                  </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px", width: "100%" }}>
            ...
            <div data-lenis-prevent="true" className="hover-scrollbar" style={{ display: "flex", flexDirection: "column", gap: "16px", width: "100%", maxHeight: "98px", overflowY: "auto", paddingBottom: "8px", paddingRight: "4px" }}>
              {(profileDetails?.user_listed_farmlands || []).map((item: any, idx: number) => (
                <div key={idx} onClick={() => router.push(`/profile/active-listing/${item.farm_id}`)} style={{ cursor: "pointer", width: "100%", background: "linear-gradient(180deg, rgba(255, 255, 255, 0.7) 0%, rgba(255, 255, 255, 0.3) 100%)", border: "1px solid rgba(255, 255, 255, 0.8)", boxShadow: "0px 8px 32px rgba(0, 0, 0, 0.05)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", borderRadius: "40px", padding: "20px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "16px", minWidth: 0, flex: 1 }}>
                  <div style={{ width: "54px", height: "56px", background: "rgba(255, 255, 255, 0.6)", border: "1px solid #FFFFFF", boxShadow: "inset 0px 2px 4px 1px #FFFFFF", backdropFilter: "blur(2px)", WebkitBackdropFilter: "blur(2px)", borderRadius: "16px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={["#059669", "#D97706", "#2563EB", "#7C3AED"][idx % 4]} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z" /><path d="M2 22l10-10" /></svg>
                  </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "16px", width: "100%" }}>
            ...
            <div data-lenis-prevent="true" className="hover-scrollbar" style={{ display: "flex", flexDirection: "column", gap: "16px", width: "100%", maxHeight: "212px", overflowY: "auto", paddingBottom: "8px", paddingRight: "4px" }}>
              {(profileDetails?.user_purchased_lands_tracking || []).map((item: any, idx: number) => (
                <div key={idx} onClick={() => router.push(`/profile/active-deals/${item.farm_id || item.farmland_id}`)} style={{ cursor: "pointer", width: "100%", background: "linear-gradient(180deg, rgba(255, 255, 255, 0.7) 0%, rgba(255, 255, 255, 0.3) 100%)", border: "1px solid rgba(255, 255, 255, 0.8)", boxShadow: "0px 8px 32px rgba(0, 0, 0, 0.05)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", borderRadius: "40px", padding: "20px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "16px", minWidth: 0, flex: 1 }}>
                  <div style={{ width: "54px", height: "56px", background: "rgba(255, 255, 255, 0.6)", border: "1px solid #FFFFFF", boxShadow: "inset 0px 2px 4px 1px #FFFFFF", backdropFilter: "blur(2px)", WebkitBackdropFilter: "blur(2px)", borderRadius: "16px", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={["#059669", "#D97706", "#2563EB", "#7C3AED"][idx % 4]} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M11 20A7 7 0 0 1 9.8 6.1C15.5 5 17 4.48 19 2c1 2 2 4.18 2 8 0 5.5-4.78 10-10 10Z" /><path d="M2 22l10-10" /></svg>
                  </div>
