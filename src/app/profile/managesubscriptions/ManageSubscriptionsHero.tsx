...
export default function ManageSubscriptionsHero() {
  ...
  return (
    <section className="w-full relative min-h-[480px] md:min-h-[640px] lg:h-[960px] flex flex-col items-center justify-center box-border overflow-hidden shrink-0 bg-[#F8F9FA]">
      ...
      <img
        ...
        alt="Manage Subscriptions Hero Background"
      ...
      <div className="absolute top-0 left-0 right-0 z-30 flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-[60px] h-20 sm:h-24 md:h-[110px] box-border">
        ...
        {/* Central Left Menu Navigation Pill Capsule exactly matching Figma layout tokens and existing icons */}
      ...
      {/* ─── FOREGROUND TYPOGRAPHY CONTENT LAYER (Centered horizontally as per Figma CSS tokens) ─── */}
